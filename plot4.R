...
with(data_subset,{
  ...
  plot(Sub_metering_1~Date_Time,type="l",ylab="Energy sub metering",xlab="",ylim=c(0,40))
  
  lines(Sub_metering_2~Date_Time,col="red")
  
  lines(Sub_metering_3~Date_Time,col="blue")
  
  legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("black","red","blue"),lty=1,lwd=2,bty = "n",cex=0.9)
